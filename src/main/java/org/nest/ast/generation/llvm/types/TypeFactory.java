...
public class TypeFactory {
    ...
    public IntType i1() { return new IntType(LLVM.LLVMInt1TypeInContext(context)); }
    public IntType i8() { return new IntType(LLVM.LLVMInt8TypeInContext(context)); }
    public IntType i16() { return new IntType(LLVM.LLVMInt16TypeInContext(context)); }
    public IntType i32() { return new IntType(LLVM.LLVMInt32TypeInContext(context)); }
    public IntType i64() { return new IntType(LLVM.LLVMInt64TypeInContext(context)); }

    public FloatType f32() { return new FloatType(LLVM.LLVMFloatTypeInContext(context)); }
    public FloatType f64() { return new FloatType(LLVM.LLVMDoubleTypeInContext(context)); }
