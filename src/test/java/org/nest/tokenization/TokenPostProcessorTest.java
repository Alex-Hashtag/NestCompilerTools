...
class TokenPostProcessorTest {
    ...
    void testKeywordProcessor() {
        ...
        assertTrue(transformed instanceof Token.Keyword);
    ...
    void testLiteralProcessor() {
        ...
        assertTrue(transformed instanceof Token.Literal);
    ...
    void testIdentifierProcessor() {
        ...
        assertTrue(transformed instanceof Token.Identifier);
    ...
    void testCommentProcessor() {
        ...
        assertTrue(transformed instanceof Token.Comment);
    ...
    void testMultipleProcessorsForSameType() {
        ...
        assertTrue(transformed2 instanceof Token.Literal);
